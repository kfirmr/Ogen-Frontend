---
applyTo: "**"
description: "Document every database schema and environment variable change as a dated migration file in the migrations folder, with the SQL script and an updated ERD, or an env-var migration note."
---
