---
applyTo: "**"
description: "Close the feedback loop and prove it works: exercise endpoints with cURL, cover logic with unit and component tests, and drive Chrome DevTools MCP for client and UI verification before declaring anything done."
---
