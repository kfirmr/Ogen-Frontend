---
applyTo: "**"
description: "Development workflow from board task to merge request: read the Trello card, move it to the active list, branch from dev, implement, attach proof of completion, open the MR into dev, and link it back to the card."
---
