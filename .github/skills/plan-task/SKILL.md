---
name: plan-task
description: "Turn a referenced Trello card into a reviewable implementation plan, then implement it only on request. Use whenever the user pastes a Trello card URL, a card short link, or a bare card number - the reference itself is the request."
---
...
[development-workflow-standards.md](../../instructions/development-workflow-standards.instructions.md):
