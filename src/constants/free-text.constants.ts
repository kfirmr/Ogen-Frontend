...
export type TFreeTextStatusType =
  (typeof FREE_TEXT_STATUS)[keyof typeof FREE_TEXT_STATUS];
...
export const FREE_TEXT_STATUS_MESSAGES: Record<
  TFreeTextStatusType,
  string | null
> = {
...
export const FREE_TEXT_DIVERGENCE_MESSAGE_PREFIX =
  "מילים אלו טרם אושרו ויידרשו אישור ידני";
...
export const FREE_TEXT_CHIP_STYLES: Record<
  TFreeTextStatusType,
