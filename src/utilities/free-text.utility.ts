...
export const getFreeTextChipLabel = (
  status: TFreeTextStatusType | null,
): string => {
  if (status === null) {
...
export const buildFreeTextDivergenceMessage = (
...
const parkPendingDraftBeforeEdit = ({
  ...
  const adjustedTargetIndex =
    insertAt <= targetIndex ? targetIndex + 1 : targetIndex;
...
const normalizeFreeTextWord = (word: string): string =>
